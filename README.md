...
**If running code on demo:**
`ctrl+shift+f` replace `subscription.xqmsg.net` with `demo-subscription.xqmsg.net`
and `validation.xqmsg.net` with `demo-validation.xqmsg.net`
